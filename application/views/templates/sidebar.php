                                ...
                                <ul class="nav nav-treeview">
                                    <?php if ($title == 'Data Petugas') : ?>
                                        ...
                                        <li class="nav-item">
                                            ...
                                            <?php endif; ?>
                                            <p><i class="fas fa-user"></i> Data Petugas</p>
                                            </a>
                                        </li>
                                        <?php if ($title == 'Data Siswa') : ?>
                                            ...
                                            <li class="nav-item">
                                                <a href="<?= site_url('masterdata/siswa') ?>" class="nav-link">
                                                    <i class="far nav-icon"></i>
                                                <?php endif; ?>
                                                <p><i class="fas fa-users"></i> Data Siswa</p>
                                                </a>
                                            </li>
                                            <?php if ($title == 'Data SPP') : ?>
                                                ...
                                                <li class="nav-item">
                                                    <a href="<?= site_url('masterdata/spp') ?>" class="nav-link">
                                                        <i class="far nav-icon"></i>
                                                    <?php endif; ?>
                                                    <p><i class="fas fa-book"></i> Data SPP</p>
                                                    </a>
                                                </li>
                                                <?php if ($title == 'Data Kelas') : ?>
                                                    ...
                                                    <li class="nav-item">
                                                        <a href="<?= site_url('masterdata/kelas') ?>" class="nav-link">
                                                            <i class="far nav-icon"></i>
                                                        <?php endif ?>
                                                        <p><i class="fas fa-school"></i> Data Kelas</p>
                                                        </a>
                                                    </li>
                                                    <?php if ($title == 'Data Jurusan') : ?>
                                                        ...
                                                        <li class="nav-item">
                                                            <a href="<?= site_url('masterdata/jurusan') ?>" class="nav-link">
                                                                <i class="far nav-icon"></i>
                                                            <?php endif ?>
                                                            <p><i class="fas fa-building"></i> Data Jurusan</p>
                                                            </a>
                                                        </li>
